...
docker run -it -v C:\Users\Raghu\Downloads\Traffic_Analysis_Agent\docs:/app/docs -e GOOGLE_API_KEY="AIzaSyC1wv9WeBWKscyJ3O9PpUzOZZunqcSuxLw" -e HEADLESS_MODE="true" tia-agent

docker run -it --entrypoint /bin/bash -v C:\Users\Raghu\Downloads\Traffic_Analysis_Agent\docs:/app/docs -e GOOGLE_API_KEY="AIzaSyC1wv9WeBWKscyJ3O9PpUzOZZunqcSuxLw" -e HEADLESS_MODE="true" tia-agent
